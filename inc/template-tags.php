...
function twentysixteen_entry_meta() {
	...
	if ( 'post' === get_post_type() and is_home() ) {
...
if ( ! function_exists( 'twentysixteen_entry_single_meta' ) ) :
    /**
     * Prints HTML with meta information for the categories, tags.
     *
     * Create your own twentysixteen_entry_single_meta() function to override in a child theme.
     *
     * @since Twenty Sixteen 1.0
     */
    function twentysixteen_entry_single_meta() {
        if ( in_array( get_post_type(), array( 'post', 'attachment' ) ) ) {
            twentysixteen_entry_date();
        }
